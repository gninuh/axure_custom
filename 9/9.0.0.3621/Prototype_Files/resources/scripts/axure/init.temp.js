$axure.internal(function($ax) {
    ...
    $(window.document).ready(function () {
        var meta='<meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, user-scalable=no, viewport-fit=cover" />';
        meta += '<meta name="apple-mobile-web-app-capable" content="yes" />';
        meta += '<meta name="apple-mobile-web-app-status-bar-style" content="white"/>';
        $("head").prepend(meta); 
